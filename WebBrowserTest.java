...
/**
 * Test class for the WebBrowser class.
 * 
...
class WebBrowserTest {
	...
	@Test
	void testWebBrowserHistoryAfterStack() throws MalformedURLException {
		URL URL1 = new URL("https://a");
		URL URL2 = new URL("https://b");
		URL URL3 = new URL("https://c");
		...
		assertEquals(URL2, w2.forward());
		assertEquals(URL3, w2.forward());

	}

	@Test
	void testWebBrowserDoubleIterator() throws MalformedURLException {
		WebBrowser webBrowser = new WebBrowser();
		...
		assertEquals(url3, iterator2.next());
